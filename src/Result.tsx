...
const data:cmd[] =[
    ...
    {command: 'github' , description: 'my github profile' , content: 'https://github.com/abderrahmaneelhamel'},
    {command: 'linkedin' , description: 'you can text me' , content: 'https://www.linkedin.com/in/abderrahmane-elhamel-11883a20a/'},
    {command: 'email' , description: 'you can email me' , content: 'abdoelhamel359@gmail.com'},
    ...
    {command: 'skills' , description: 'i\'m good at some stuff' , 
      content: {
        frontEnd :['HTML', 'CSS', 'Bootstrap', 'TailwindCSS', 'JavaScript', 'JQuery', 'ReactJS', 'TypeScript', 'VueJS', 'Angular','NextJS'],
        backEnd  :['PHP', 'Laravel','NodeJS', 'Python', 'Java' , 'JavaEE', 'Spring Boot'], 
        database:['MySQL','Postgres'],
        tools: ['VScode','Vim','eclipse','intellij', 'UML', 'AWS', 'Linux','netBeans', 'Git', 'Github', 'Gitlab', 'Figma', 'jira','Docker']}},
    {command: 'repo' , description: 'check this project\'s repository' ,content:'https://github.com/abderrahmaneelhamel/my-portfolio'},
            ...
            if(cm.command==='projects'){
              return(
                <div>
                  ...
                  <p>resume builder : <A target='_blank' href="https://github.com/abderrahmaneelhamel/cv-builder">www.github.com/abderrahmaneelhamel/cv-builder</A> </p>               
                  <p>mirror writing generator : <A target='_blank' href="https://mirror-writing.vercel.app/">mirror-writing.vercel.app/</A> </p>               
                  <p>cryptography website : <A target='_blank' href="https://github.com/abderrahmaneelhamel/Encrypt">www.github.com/abderrahmaneelhamel/Encrypt</A> </p>               
                  <p>e-commerce platform : <A target='_blank' href="https://github.com/abderrahmaneelhamel/file_rouge">www.github.com/abderrahmaneelhamel/file_rouge</A> </p>               
                </div>
              )
